  ...
  export const Applications = () => {
      ...
      const getStatusColor = (statusNumber) => {
          switch (statusNumber) {
              case 10:
                  return { bgcolor: '#e3f2fd', color: '#1565c0' }; // כחול בהיר
              case 11:
                  return { bgcolor: '#fff8e1', color: '#ff8f00' }; // כתום
              case 12:
                  return { bgcolor: '#f3e5f5', color: '#7b1fa2' }; // סגול
              case 13:
                  return { bgcolor: '#e8f5e8', color: '#2e7d32' }; // ירוק
              default:
                  return { bgcolor: '#e0e0e0', color: '#616161' }; // אפור
          }
      };
