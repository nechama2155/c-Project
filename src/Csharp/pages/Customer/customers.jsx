  ...
  export const Customers = () => {
      ...
      const scrollToTop = () => {
          const scrollableElement = document.querySelector('.scrollable-customers');
      ...
      return (
          <Box sx={{ 
              height: '90vh', // גובה קבוע לקומפוננטה
              display: 'flex', 
              flexDirection: 'column',
              overflow: 'hidden' // מניעת גלילה בקונטיינר החיצוני
          }} ref={topRef}>
              ...
              {/* חלק הטבלה - עטוף ב-Box עם גלילה */}
              <Box 
                  className="scrollable-customers"
                  sx={{ 
                      flexGrow: 1, 
                      overflowY: 'auto', // אפשור גלילה אנכית
                      '&::-webkit-scrollbar': {
                          display: 'none' // הסתרת פס הגלילה בדפדפנים מבוססי Webkit
                      },
                      msOverflowStyle: 'none', // הסתרת פס הגלילה ב-IE/Edge
                      scrollbarWidth: 'none', // הסתרת פס הגלילה ב-Firefox
                  }}
              >
